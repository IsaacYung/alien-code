...
function twentysixteen_custom_header_and_background() {
	...
	/**
	 * Filter the arguments used when adding 'custom-background' support in Alien Style.
	 *
	 * @since Alien Style 1.0
	 *
	 * @param array $args {
	...
	/**
	 * Filter the arguments used when adding 'custom-header' support in Alien Style.
	 *
	 * @since Alien Style 1.0
	 *
	 * @param array $args {
